...
final controlLightProvider = buildGenerativeModel(
...
final _updateBrightness = LlmFunctionDeclaration(
  ...
  handler: (args) => lightControlController.post(args),
);

final updateBrightnessWidget = LlmWidgetDeclaration(
  declaration: _updateBrightness,
  build: (element) => LightControlWidgetResponse(element),
);
